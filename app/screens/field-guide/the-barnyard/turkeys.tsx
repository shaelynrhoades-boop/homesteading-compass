...
const turkeyTypes = ['Heritage Turkeys', 'Commercial Turkeys'];

const nextSteps = [
  {
    name: 'Selling Turkey Products',
    alert:
      'Future topics:\n• Selling milk\n• Selling meat\n• Local regulations\n• Pricing & packaging\n• Farmers markets\n\nComing soon 🐄',
  },
  {
    name: 'Find a Turkey Group',
    alert:
      'Will connect to:\n• The Waystation\n• Local stockyards\n• Trades & advice\n\nComing soon 🌱',
  },
  {
...
export default function Turkeys() {
  return (
    ...
    >
      <Text style={styles.title}>Turkeys</Text>
      <View style={{ alignItems: 'flex-end', marginBottom: 10 }}>
        <InfoButton text="Guides for turkey housing, feeding, and seasonal care. Connects to: Log Book." />
      </View>

      <Text style={styles.intro}>
        Turkeys are one of the most versatile and beginner-friendly livestock
        on the homestead. Whether raising for meat, eggs, or both, proper setup
        and care are key to a healthy herd.
      </Text>

      {/* Turkeys Basics */}
      <Text style={styles.sectionHeader}>Turkeys Basics</Text>
      <View style={styles.grid}>
        {turkeysSections.map((item) => (
          <Pressable
            key={item}
            style={styles.button}
            onPress={() =>
              router.push({
                ...
                params: { animal: 'Turkeys', topic: item },
              })
            }
          >
      ...
      {/* Turkey Types */}
      <Text style={styles.sectionHeader}>Turkey Types</Text>
      <View style={styles.grid}>
        {turkeyTypes.map((item) => (
          <Pressable
            key={item}
            ...
            onPress={() =>
              router.push({
                ...
                params: { animal: 'Turkeys', type: item },
              })
            }
          >
          ...
          <Pressable
            ...
            onPress={() =>
              router.push({
                ...
                params: { animal: 'Turkeys', step: step.name },
              })
            }
          >
