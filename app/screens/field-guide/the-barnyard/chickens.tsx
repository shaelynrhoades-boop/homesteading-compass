...
const chickenTypes = ['Meat Chickens', 'Egg Layers'];

const nextSteps = [
  {
    name: 'Selling Chicken Products',
    alert:
      'Future topics:\n• Selling eggs\n• Selling meat birds\n• Local regulations\n• Pricing & packaging\n• Farmers markets\n\nComing soon 🐓',
  },
  {
    name: 'Find a Chicken Group',
    alert:
...
export default function Chickens() {
  return (
    ...
    >
      <Text style={styles.title}>Chickens</Text>
      <View style={{ alignItems: 'flex-end', marginBottom: 10 }}>
        <InfoButton text="Care guides for housing, health, and seasonal chicken management. Connects to: Log Book." />
      </View>

      <Text style={styles.intro}>
        Chickens are one of the most versatile and beginner-friendly livestock
        on the homestead. Whether raising for eggs, meat, or both, proper setup
        and care are key to a healthy flock.
      </Text>

      {/* Chicken Basics */}
      <Text style={styles.sectionHeader}>Chicken Basics</Text>
      <View style={styles.grid}>
        {chickenSections.map((item) => (
          <Pressable
            key={item}
            style={styles.button}
            onPress={() =>
              router.push({
                ...
                params: { animal: 'Chickens', topic: item },
              })
            }
          >
      ...
      {/* Chicken Types */}
      <Text style={styles.sectionHeader}>Chicken Types</Text>
      <View style={styles.grid}>
        {chickenTypes.map((item) => (
          <Pressable
            key={item}
            ...
            onPress={() =>
              router.push({
                ...
                params: { animal: 'Chickens', type: item },
              })
            }
          >
          ...
          <Pressable
            ...
            onPress={() =>
              router.push({
                ...
                params: { animal: 'Chickens', step: step.name },
              })
            }
          >
