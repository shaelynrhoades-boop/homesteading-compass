...
const sheepTypes = ['Meat Sheep', 'Dairy Sheep', 'Fiber Sheep'];

const nextSteps = [
  {
    name: 'Selling Sheep Products',
    alert:
      'Future topics:\n• Selling milk\n• Selling meat\n• Local regulations\n• Pricing & packaging\n• Farmers markets\n\nComing soon 🐄',
  },
  {
    name: 'Find a Sheep Group',
    alert:
      'Will connect to:\n• The Waystation\n• Local stockyards\n• Trades & advice\n\nComing soon 🌱',
  },
  {
  ...
  return (
    ...
    >
      ...
      <View style={{ alignItems: 'flex-end', marginBottom: 10 }}>
        <InfoButton text="Guides for housing, pasture care, and seasonal sheep health. Connects to: Log Book." />
      </View>

      <Text style={styles.intro}>
        Sheep are one of the most versatile and beginner-friendly livestock
        on the homestead. Whether raising for milk, meat, or both, proper setup
        and care are key to a healthy herd.
      </Text>

      {/* Sheep Basics */}
      <Text style={styles.sectionHeader}>Sheep Basics</Text>
      <View style={styles.grid}>
        {sheepSections.map((item) => (
          <Pressable
            key={item}
            style={styles.button}
            onPress={() =>
              router.push({
                ...
                params: { animal: 'Sheep', topic: item },
              })
            }
          >
      ...
      {/* Sheep Types */}
      <Text style={styles.sectionHeader}>Sheep Types</Text>
      <View style={styles.grid}>
        {sheepTypes.map((item) => (
          <Pressable
            key={item}
          ...
          <Pressable
            ...
            onPress={() =>
              router.push({
                ...
                params: { animal: 'Sheep', step: step.name },
              })
            }
          >
